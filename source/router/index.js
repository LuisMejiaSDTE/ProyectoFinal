...
//dbContactos.Contactos.insertar({nombre:'jose', domicilio:'av del sol 666', telefono:'6692272090'});
...
router.post('/contactos', async (req,res) => {
    ...
    res.render('contactos.html', { titulo : 'Contactos', contactos: contactos, contacto: null })
});
...
router.get('/contactos/id', async (req,res) => {
    ...
    res.render('contactos.html', { titulo: 'Contactos', contactos: [], contacto: contacto[0]});
});
